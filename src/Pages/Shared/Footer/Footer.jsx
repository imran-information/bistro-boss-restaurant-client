            ...
            <div className="footer justify-evenly  bg-[#1F2937] p-20 ">
                ...
                <nav>
                    ...
                    <div className="grid grid-flow-col gap-4 my-3">
                        <a href='https://www.facebook.com/imran.informations/' target='blank'>
                            <svg
                        ...
                        <a href='https://www.facebook.com/imran.informations/' target='blank'>
                            ...
                            <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
